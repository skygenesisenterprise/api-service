...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Build routes (simplified) - excluding problematic routes
    ...
    // let voip_routes = crate::routes::voip_routes::voip_routes();
    // let mac_routes = crate::routes::mac_routes::mac_routes();
