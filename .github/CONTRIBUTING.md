...
# Contributing to API Service

Thank you for your interest in contributing to **API Service**!  
...
We follow a [Code of Conduct](https://github.com/skygenesisenterprise/api-service/CODE_OF_CONDUCT.md) to ensure a safe, respectful, and inclusive environment.  
...
Open a [GitHub Discussion](https://github.com/skygenesisenterprise/api-service/discussions)
Or reach out to us at [contact@skygenesisenterprise.com](mailto:contact@skygenesisenterprise.com)

Thank you for helping improve to the API Service! 💌
